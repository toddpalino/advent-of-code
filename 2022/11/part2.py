...
# Find a divisor that will not affect divisibility checks
reductor = 1
for monkey in monkeys:
	reductor *= monkey.test_divisor
for monkey in monkeys:
	monkey.reductor = reductor
...
for i in range(1, 10001):
	...
	if i % 1000 == 0:
		...
		for monkey in monkeys:
			print("Monkey %d inspected items %d times." % (monkey._id, monkey.inspected))
